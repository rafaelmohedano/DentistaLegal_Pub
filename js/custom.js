...
//##### Ativa Menu pela posição do Scroll #####
      ...
      jQuery("#contactfrm").validate({
        ...
        submitHandler: function( form ){
            ...
            $.ajax({
                ...
                error: function () {
                    // jQuery('.result').html("<div class='alert alert-error'>Infelizmente não foi possível enviar seus dados, por favor tente novamente.</div>");
...
function initialize(id) {
    ...
    var locations = [
        //point number 1
        ['Rua Coronel Morais, 159', 'Canindé, São Paulo, SP', -23.529445, -46.617436]
